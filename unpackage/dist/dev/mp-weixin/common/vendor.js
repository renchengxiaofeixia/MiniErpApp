...
/***/ 12:
/*!**************************************************************!*\
  !*** C:/Users/admin/Desktop/采购订单/MiniErpApp/libs/request.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var del = function del(url, data) {var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  options.type = 'DELETE';
  options.data = data;
  options.url = url;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.navBack = exports.navtab = exports.navto = void 0;var navto = function navto(url, data) {
  console.log(url);
...
var navtab = function navtab(url, data) {
  console.log(url);
  uni.switchTab({
    url: '/' + url });
...
// 返回上一页
exports.navtab = navtab;var navBack = function navBack() {
  uni.navigateBack();
};
...
/***/ 5:
/*!*********************************************************!*\
  !*** C:/Users/admin/Desktop/采购订单/MiniErpApp/pages.json ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
