...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/message/index.vue */ 35));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
{
  components: {
    headerTab: headerTab, //头部导航栏
    searchbox: searchbox, //搜索框
    filtratePopup: filtratePopup, //筛选
    dataGrid: dataGrid, //数据列表
    addOrder: addOrder, //新建页面
